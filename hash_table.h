...
/*
    Field/Description:
    hash - 32-bit unsigned int for hash value produced by running name through
   Jenkins one at a time function. name - String up to len(50) salary - 32-bit
   unsigned next - pointer to next node in list
*/

void setInsertCounter(int numberOfInserts);
